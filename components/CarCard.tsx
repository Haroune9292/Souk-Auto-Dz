...
export default function CarCard({ car }: { car: any }) {
  ...
  // معالجة أمان الصور (تدعم النصوص، المصفوفات، أو البيانات الفارغة)
  ...
  const handleImageClick = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
    console.log("Image clicked! Opening modal for car:", car?.title);
    setActiveImgIndex(0);
    setShowModal(true);
  };
  ...
  return (
    <>
      ...
      {/* نافذة عرض الصور المنبثقة (Lightbox) */}
      {showModal && (
