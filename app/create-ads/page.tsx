...
export default function CreateAd() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      {/* Hero Section with Local Market Entrance Image */}
      <div 
        className="relative h-80 flex items-center justify-center bg-cover bg-center"
        style={{ 
            backgroundImage: "linear-gradient(rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.9)), url('/market-bg.jpg')" 
        }}
      >
      ...
      <div className="max-w-4xl mx-auto -mt-24 px-4 pb-20 relative z-20">
        <form onSubmit={handleSubmit} className="bg-white/95 backdrop-blur-xl text-slate-900 rounded-3xl shadow-2xl p-8 md:p-12 border border-white/20">
          ...
          {error && <div className="mb-6 p-4 bg-red-100 text-red-700 rounded-xl font-bold border border-red-200">{error}</div>}
          ...
          <div className="mb-8 border-t border-slate-200 pt-8">
            ...
            <div className="space-y-4">
              ...
              <input value={images} onChange={(e) => setImages(e.target.value)} className="w-full bg-slate-100 rounded-xl py-3 px-4 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Image URLs (comma separated)" />
            </div>
          </div>
